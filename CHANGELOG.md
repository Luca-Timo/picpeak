...
## [3.57.0-beta.0](https://github.com/Luca-Timo/picpeak/compare/v3.56.0-beta.0...v3.57.0-beta.0) (2026-06-01)
...
* **api/v1:** accept category_id on POST /events/:id/photos ([2d5a2ad](https://github.com/Luca-Timo/picpeak/commit/2d5a2ad78a5f6c101315214399a9c158ff0549da))
* **api/v1:** accept category_id on POST /events/:id/photos ([6901e26](https://github.com/Luca-Timo/picpeak/commit/6901e2661ed74e69f19c52ce046ee911b818d463))
...
* **branding:** 8-token CI palette + force color mode + dark-mode consistency ([8050927](https://github.com/Luca-Timo/picpeak/commit/80509276074b8125b6d676839afabb0b6f89206f))
* **branding:** Customer dashboard header toggles in Branding page ([b252cb6](https://github.com/Luca-Timo/picpeak/commit/b252cb67eb3645224a279fbbe9c14871438473f8))
* **branding:** force color mode (dark or light) site-wide ([5a162fc](https://github.com/Luca-Timo/picpeak/commit/5a162fc8bec47a49cb1bcaa92ff72e197e8d2e42))
* **branding:** inline force color mode with auto-save + clearer palette help text ([67d7d8d](https://github.com/Luca-Timo/picpeak/commit/67d7d8d3fa25ceab0eda02b291f2e220b222f84a))
* **branding:** per-family generic fallback via meta.json ([dcff451](https://github.com/Luca-Timo/picpeak/commit/dcff4515721482e06c2ef1c1eb34f9e12754c07c))
* **branding:** preview each font in its own face in the picker dropdown ([b4f9b65](https://github.com/Luca-Timo/picpeak/commit/b4f9b65f1df4c400f22b28f20e1304ec57279d33))
* **branding:** self-hosted webfonts with filesystem scanner ([d04bf28](https://github.com/Luca-Timo/picpeak/commit/d04bf288084144bf53ef0ba988fa32ed703d7351))
* **branding:** self-hosted webfonts with filesystem scanner ([bac51fe](https://github.com/Luca-Timo/picpeak/commit/bac51fe69a39f85381f445e8da6cd63cf5826fc4))
* **branding:** toggle login-page logo frame + size ([75e41eb](https://github.com/Luca-Timo/picpeak/commit/75e41eba036d07e6abaab301db42d16e77dd01be))
* **clients:** scaffold top-level Clients section with sub-nav around Accounts ([9091ed4](https://github.com/Luca-Timo/picpeak/commit/9091ed4012a85400f216ebfb40d5720c2c86a826))
* **cms:** add external URL toggle for imprint and privacy pages ([b2c8161](https://github.com/Luca-Timo/picpeak/commit/b2c8161a43c2d0b09d6783e791b3f26862254824))
* **cms:** add per-page external URL override — backend ([66423bb](https://github.com/Luca-Timo/picpeak/commit/66423bb65e83b6204509c9a98d783ba8255c3364))
* **cms:** admin UI for external imprint/privacy URL ([a4e3d10](https://github.com/Luca-Timo/picpeak/commit/a4e3d10fb0c97ea07c4b08d16c0947945d8a7576))
* **cms:** redirect legal links to external URL when configured ([c5bba50](https://github.com/Luca-Timo/picpeak/commit/c5bba505ac92b5257f6bb1c069b8bc23ea6a5a1b))
...
* **crm:** backend code — services + routes + utilities + tests ([d543949](https://github.com/Luca-Timo/picpeak/commit/d543949188e34625f7d0fa93606ad6cb22553b0b))
* **crm:** frontend code — pages + services + components ([a7e16e7](https://github.com/Luca-Timo/picpeak/commit/a7e16e7bf668ff06158f95e13843413d43a55cd4))
...
* customer accounts ([#354](https://github.com/Luca-Timo/picpeak/issues/354)) — recurring logins, profile, password reset, branded customer surface ([fe52953](https://github.com/Luca-Timo/picpeak/commit/fe5295373b0bfeec1e81086206ffab7ce1b91094))
...
* **customers:** "Manage galleries" dialog with immediate access revocation + section reorder + portal-flag revert ([9be9296](https://github.com/Luca-Timo/picpeak/commit/9be9296eb58d7733d0b5f8ce6eb48e9832f65e7c))
* **customers:** customer portal ([#354](https://github.com/Luca-Timo/picpeak/issues/354)) on top of feature-flags reorg ([087ef45](https://github.com/Luca-Timo/picpeak/commit/087ef45942a8a51d09af2cd8ec85aca330f6cf7f))
...
* **downloads:** preserve original camera filenames on download (opt-in) ([#493](https://github.com/Luca-Timo/picpeak/issues/493)) ([826e43e](https://github.com/Luca-Timo/picpeak/commit/826e43ebac940782be234630c50bbd54a3250f98))
* **downloads:** preserve original camera filenames on download (opt-in) ([#493](https://github.com/Luca-Timo/picpeak/issues/493)) ([7eeef2b](https://github.com/Luca-Timo/picpeak/commit/7eeef2ba98a71a8b948cabf7f1c65eb3eb271d22))
* **email-templates:** categorise + link to feature flags ([84c06af](https://github.com/Luca-Timo/picpeak/commit/84c06affb73687529e35dbbac15801deb41dc4f2))
* **email-templates:** categorise + sub-categorise + link to feature flags ([2cae3fe](https://github.com/Luca-Timo/picpeak/commit/2cae3fe47deb667af5991ae1a90e3b5698693119))
* **email-templates:** group Templates UI by category + Feature off chip ([5ec26fc](https://github.com/Luca-Timo/picpeak/commit/5ec26fc9981028163cab122e229c83cdbbf35828))
...
* **email-templates:** seed missing nl/pt/ru/fr translations ([358f7ee](https://github.com/Luca-Timo/picpeak/commit/358f7ee99e2941ad179d5859178b35a80886542f))
* **email:** expand email palette to 8 tokens + Sync from Branding button ([47b6b39](https://github.com/Luca-Timo/picpeak/commit/47b6b39f3a942aee93b970031d95a952cb769d09))
* **events:** add Photos column to admin events list ([#384](https://github.com/Luca-Timo/picpeak/issues/384)) ([d561db8](https://github.com/Luca-Timo/picpeak/commit/d561db802b04db8fbb38819a22e840532e775ef0))
* **events:** add Photos column to admin events list ([#384](https://github.com/Luca-Timo/picpeak/issues/384)) ([ffb4318](https://github.com/Luca-Timo/picpeak/commit/ffb4318a1f667e273cd59805673b125d2f17699b))
* **events:** bulk delete with password confirmation ([#384](https://github.com/Luca-Timo/picpeak/issues/384)) ([647aea2](https://github.com/Luca-Timo/picpeak/commit/647aea21ae42fe0d089bf45568702617a25b98e4))
* **events:** bulk delete with password confirmation ([#384](https://github.com/Luca-Timo/picpeak/issues/384)) ([48d538f](https://github.com/Luca-Timo/picpeak/commit/48d538f94fd39d9b85ec57c57301a8490b7d4f6d))
* **events:** default Guest Feedback ON via admin setting ([#520](https://github.com/Luca-Timo/picpeak/issues/520)) ([3465b55](https://github.com/Luca-Timo/picpeak/commit/3465b55abc98e52cf58ba46b811f4ec115d53012))
* **events:** prefill admin email + admin picker on event creation ([3fe8e61](https://github.com/Luca-Timo/picpeak/commit/3fe8e61bd1175e35dcb61604447e5d9c2e902ec5))
* **events:** prefill admin email + admin picker on event creation ([ee56b67](https://github.com/Luca-Timo/picpeak/commit/ee56b6762f5b2eb9ea42f4abe4dde4356e2e54e6))
* **events:** Sync from Branding button in gallery theme customizer + clarified default inheritance ([bdbe7b8](https://github.com/Luca-Timo/picpeak/commit/bdbe7b80a13b8b215ac544ba9105100e792eeda2))
* **events:** tree view for external media folder picker ([cdd40ac](https://github.com/Luca-Timo/picpeak/commit/cdd40acb4591d4eb8f80a79c69201556eab1bfd0))
* **events:** tree view for external media folder picker ([f927b09](https://github.com/Luca-Timo/picpeak/commit/f927b09c70f3b6a5c81c3726609a29680b96b6fc))
* **footer:** hideable legal links + socials + promo banner ([#441](https://github.com/Luca-Timo/picpeak/issues/441) + [#440](https://github.com/Luca-Timo/picpeak/issues/440)) ([f3505c2](https://github.com/Luca-Timo/picpeak/commit/f3505c2631cc5b4ae13a0f0d593a1ddd95fefdcb))
* **footer:** hideable legal links + socials + promo banner ([#441](https://github.com/Luca-Timo/picpeak/issues/441) + [#440](https://github.com/Luca-Timo/picpeak/issues/440)) ([3a731e7](https://github.com/Luca-Timo/picpeak/commit/3a731e7c95a75f6db42f903b1e6e560c3e024e6a))
* **gallery:** decouple header style from layout, add banner option ([1f1a856](https://github.com/Luca-Timo/picpeak/commit/1f1a856083b1966ed4b32a23a14442f1727cecef))
* **gallery:** decouple header style from layout, add banner option ([24d7277](https://github.com/Luca-Timo/picpeak/commit/24d727752c442263a6469e0aefa666454a4c652f))
* **gallery:** decouple header style from layout, add banner option ([aff29c9](https://github.com/Luca-Timo/picpeak/commit/aff29c91bbb250debe74e2a512047ee40e157a34))
* **gallery:** icon-only menu, accent Download CTA ([#386](https://github.com/Luca-Timo/picpeak/issues/386)) ([876b35b](https://github.com/Luca-Timo/picpeak/commit/876b35b4a512f70cfc19561e35ce9d915a599547))
* **gallery:** icon-only menu, accent Download CTA, logo aligned ([#386](https://github.com/Luca-Timo/picpeak/issues/386)) ([de8ad5f](https://github.com/Luca-Timo/picpeak/commit/de8ad5fdd5ce1b9552ca8ca6e405d15c7372a4c8))
...
* **i18n:** add Brazilian Portuguese (pt-BR) locale ([375f512](https://github.com/Luca-Timo/picpeak/commit/375f51285b5db9c0dfcc04761d24927282e57796))
* **i18n:** add Spanish (es) locale ([#510](https://github.com/Luca-Timo/picpeak/issues/510)) ([061712e](https://github.com/Luca-Timo/picpeak/commit/061712ebf143a58102334201c09a52e4c96880f0))
* **i18n:** improve pt locale with pt-BR phrasings, remove duplicate pt-BR file ([f25559c](https://github.com/Luca-Timo/picpeak/commit/f25559c0e76776f7cfe8d187e1fea05e751bbafe))
...
* **install:** skip legacy chain when modern bootstrap fingerprint detected ([#530](https://github.com/Luca-Timo/picpeak/issues/530)) ([8f0108c](https://github.com/Luca-Timo/picpeak/commit/8f0108ce233f457d6a0f4f3dbc3e1b0a7217e74e))
* **lightbox:** medium-resolution preview tier ([#492](https://github.com/Luca-Timo/picpeak/issues/492)) ([3083c74](https://github.com/Luca-Timo/picpeak/commit/3083c748b92fe7800044125524d053f5eeb28d4a))
* **lightbox:** medium-resolution preview tier ([#492](https://github.com/Luca-Timo/picpeak/issues/492)) ([61f1d13](https://github.com/Luca-Timo/picpeak/commit/61f1d132104f485cfde9bd874e1c0ffdc042c4af))
...
* **lightbox:** save photo to Photos app on mobile via Web Share ([#531](https://github.com/Luca-Timo/picpeak/issues/531)) ([b2bbf7e](https://github.com/Luca-Timo/picpeak/commit/b2bbf7efb5ded63e8c7438d5288d351cb9124ce8))
* **lightbox:** surface original camera filenames ([#508](https://github.com/Luca-Timo/picpeak/issues/508)) ([33de294](https://github.com/Luca-Timo/picpeak/commit/33de294d570ced267d89223cb398ef8bdf99e91d))
* **localization:** add French translations for fit options in thumbnails ([2c12885](https://github.com/Luca-Timo/picpeak/commit/2c1288583fe787c1514c3cace0e2d92a212bb3a3))
* **localization:** add i18next configuration and CLI commands for localization management ([74e87b9](https://github.com/Luca-Timo/picpeak/commit/74e87b968b3152603dbfca72fae06372b7c7f519))
* **localization:** add i18next extraction helper & refactor backup configuration component to tsx ([e7228b0](https://github.com/Luca-Timo/picpeak/commit/e7228b07805a40aa67ccb7e3592848218eabbca2))
* **localization:** add missing translations ([86ee6c8](https://github.com/Luca-Timo/picpeak/commit/86ee6c80aa1f26b2ad47775337ebed301193e662))
* **localization:** improve English translations for clarity and consistency ([46b99c6](https://github.com/Luca-Timo/picpeak/commit/46b99c629215832e66d9215a210fd6eaf8c89fb4))
* **localization:** update thumbnail settings and add fit options translations ([5fc427c](https://github.com/Luca-Timo/picpeak/commit/5fc427c74b5cdda6ce1568006d9a94abdc692b3b))
* native multi-arch Docker images (Apple Silicon, ARM64 Linux) ([df30618](https://github.com/Luca-Timo/picpeak/commit/df3061893d154152b75b8ab0d07e0b1e0078431d))
* **og:** per-event opt-in to use hero photo as social-share preview ([#474](https://github.com/Luca-Timo/picpeak/issues/474)) ([d856340](https://github.com/Luca-Timo/picpeak/commit/d856340f0d230ad26539ba1088f739f03aaafc13))
* **og:** per-event opt-in to use hero photo as social-share preview ([#474](https://github.com/Luca-Timo/picpeak/issues/474)) ([0bc7e2a](https://github.com/Luca-Timo/picpeak/commit/0bc7e2af171d1a4c6e91ba541d293b90c17c111b))
...
* **restore:** self-heal restore_allow_force default ON at boot ([b57ca13](https://github.com/Luca-Timo/picpeak/commit/b57ca133abdbd11aca5e5128fc7cd86a940575f6))
...
* **settings:** Features tab + sidebar reorg with feature-flag gating ([c3798e1](https://github.com/Luca-Timo/picpeak/commit/c3798e19c8f928eac0ca1d7694d1ecfd78a1e437))
* **settings:** Features tab + sidebar reorg with feature-flag gating ([15e3336](https://github.com/Luca-Timo/picpeak/commit/15e333681fe4ce94afa8e5b477b339b179d0195a))
* support Apple Silicon natively via multi-arch images ([c282a72](https://github.com/Luca-Timo/picpeak/commit/c282a72bd35db062cec25770a42cf9c803388e44))
* **theme:** expand color settings to 8-token CI palette + alt button ([114aab5](https://github.com/Luca-Timo/picpeak/commit/114aab57771a4bba03a9e5c616c75a37c9b25969))
* **translations:** add French language support and improve localization handling ([a5db4bd](https://github.com/Luca-Timo/picpeak/commit/a5db4bd46e6a5cc84c9563588f90d3461c277528))
* **upload:** async photo processing — backend (PR-B part 1) ([851744c](https://github.com/Luca-Timo/picpeak/commit/851744c3c4df7deba8d946b6592fdb5042c52a26))
* **upload:** async photo processing — frontend (PR-B part 2) ([3b827b8](https://github.com/Luca-Timo/picpeak/commit/3b827b80d51269e1a7b9c693396f3cb7a9a48ffc))
* **upload:** async photo processing + fix(auth): /auth/session symmetry (loop fix) ([907bcf1](https://github.com/Luca-Timo/picpeak/commit/907bcf1eb2d44ded149a1caf39ee1cfe63fec994))
* **upload:** two-state UI + temp dir cleanup (PR-A of async processing) ([86dfcc4](https://github.com/Luca-Timo/picpeak/commit/86dfcc4f116a394e7e092ab3e01f3f1d030bb367))
...
* **admin-ui:** backup download button hits API path, not SPA route ([cf75a32](https://github.com/Luca-Timo/picpeak/commit/cf75a322d49c26b522c6f0ff59f334459e9fb320))
...
* **admin-users:** normalise date fields to ISO across DB drivers ([#485](https://github.com/Luca-Timo/picpeak/issues/485)) ([d300426](https://github.com/Luca-Timo/picpeak/commit/d3004263905edeffe59065e201f203a6768b4384))
* **admin-users:** normalise date fields to ISO across DB drivers ([#485](https://github.com/Luca-Timo/picpeak/issues/485)) ([b6b58d0](https://github.com/Luca-Timo/picpeak/commit/b6b58d0659fc8caee68a65e112780a1122d55907))
* **admin:** tab underlines use accent (not accent-dark) for proper highlight color ([565ae45](https://github.com/Luca-Timo/picpeak/commit/565ae45ca71e46166c8bbfc0eb0b6da92d74f120))
* **admin:** test email always sends, regardless of update availability ([#418](https://github.com/Luca-Timo/picpeak/issues/418)) ([9326a42](https://github.com/Luca-Timo/picpeak/commit/9326a427b32458dfdaa01530bac66cda84ed7b72))
* **admin:** test email always sends, regardless of update availability ([#418](https://github.com/Luca-Timo/picpeak/issues/418)) ([c2b1854](https://github.com/Luca-Timo/picpeak/commit/c2b1854df631354a977d737e8a00ddbc6fa8889f))
* **api/v1:** accept color_theme + create feedback row on event create ([#550](https://github.com/Luca-Timo/picpeak/issues/550)) ([7ef0e40](https://github.com/Luca-Timo/picpeak/commit/7ef0e40e7cee2ab6eeea4fe75c558e930e31241d))
* **api/v1:** accept color_theme + create feedback row on event create ([#550](https://github.com/Luca-Timo/picpeak/issues/550)) ([1b521e7](https://github.com/Luca-Timo/picpeak/commit/1b521e761c3e2cc6c885d03ef746aa7e77e6f067))
* **api/v1:** scope category lookup to event_owned or global ([92bb9e1](https://github.com/Luca-Timo/picpeak/commit/92bb9e1a12f77ce5e8c1286716198362b2bfdff2))
* **auth:** /auth/session must enforce session timeout symmetrically ([#350](https://github.com/Luca-Timo/picpeak/issues/350) recurrence) ([c8e09c2](https://github.com/Luca-Timo/picpeak/commit/c8e09c2a2a7d0920901560317eecd773b83251c0))
* **auth:** /auth/session must enforce session timeout symmetrically ([#350](https://github.com/Luca-Timo/picpeak/issues/350) recurrence) ([b106da1](https://github.com/Luca-Timo/picpeak/commit/b106da1ededa27fc8727f2c0e74a9182e6e9c895))
* **auth:** /auth/session must reject tokens that adminAuth/galleryAuth would reject ([f905f7e](https://github.com/Luca-Timo/picpeak/commit/f905f7e7336c756e73a8c650c9239b171697164a))
* **auth:** /auth/session must verify issuer claim like adminAuth ([#350](https://github.com/Luca-Timo/picpeak/issues/350)) ([83dedbc](https://github.com/Luca-Timo/picpeak/commit/83dedbcd45e34a924594dd83f6e3561f776576fb))
* **auth:** default COOKIE_SECURE to 'auto' in production + first-install UX ([#427](https://github.com/Luca-Timo/picpeak/issues/427)) ([e1c9382](https://github.com/Luca-Timo/picpeak/commit/e1c93823c4a3095dd2afa618f393a061806f18a3))
* **auth:** default COOKIE_SECURE to 'auto' in production + first-install UX ([#427](https://github.com/Luca-Timo/picpeak/issues/427)) ([5c7de96](https://github.com/Luca-Timo/picpeak/commit/5c7de96b7fda9ca037a01b93fabe69d1be224893))
* **auth:** restore COOKIE_SECURE='auto' default for production ([adfa29e](https://github.com/Luca-Timo/picpeak/commit/adfa29e91eeea52aa672e38269c389a5178d9e5a))
...
* **backup-history:** show Total + Other so per-row sums match the count ([aa8b5c4](https://github.com/Luca-Timo/picpeak/commit/aa8b5c4cc41a189ceef5d248d5029236ab9ec8f2))
...
* **backup-ui:** respect general_date_format + general_time_format ([f5180d0](https://github.com/Luca-Timo/picpeak/commit/f5180d0ca9be3666ba370d9b922f03bd687cfba1))
...
* **brand-title:** runtime substitution so GHCR-image users can override ([#521](https://github.com/Luca-Timo/picpeak/issues/521) follow-up) ([efa6b4a](https://github.com/Luca-Timo/picpeak/commit/efa6b4a2059f1da52ef435ec84bc548040dfa7e5))
* **branding:** admin sidebar uses accent-dark, primary buttons follow CI token ([fc2bce3](https://github.com/Luca-Timo/picpeak/commit/fc2bce3a01f02b2d131ca4ce1c8e81fc9dc62755))
* **branding:** comprehensive sweep — replace remaining primary-* legacy colors with accent tokens ([578a174](https://github.com/Luca-Timo/picpeak/commit/578a1745b8d010eeeb261d3452fd192b1ec7bcf8))
* **branding:** selected-state accent colors, force-mode actually flips galleries, compact color picker layout ([5b410ed](https://github.com/Luca-Timo/picpeak/commit/5b410ed9f87daad8e96345a86897f2a9e9419802))
* **branding:** socials + promo round-trip from DB to form ([#460](https://github.com/Luca-Timo/picpeak/issues/460)) ([bd2288e](https://github.com/Luca-Timo/picpeak/commit/bd2288e6a01786cec0649b3326189e9737db359e))
* **branding:** socials + promo round-trip from DB to form ([#460](https://github.com/Luca-Timo/picpeak/issues/460)) ([ae64a6a](https://github.com/Luca-Timo/picpeak/commit/ae64a6acbc119f78394e65cee7bf49910e1c7013))
* **branding:** working tooltips, high-contrast selected states, gallery chrome follows accent ([b19bb0c](https://github.com/Luca-Timo/picpeak/commit/b19bb0c6208744f329cb3e99f4e26a83f191710a))
* **bug-batch-518:** lightbox comments toggle + further fixes ([633a2ae](https://github.com/Luca-Timo/picpeak/commit/633a2ae72405ae1fc885cb710ed896476ffee467))
* **categories:** strip diacritics from auto-generated slugs ([a747eb3](https://github.com/Luca-Timo/picpeak/commit/a747eb351d1cf0ed269751cb685b504993d33dde))
* **categories:** strip diacritics from auto-generated slugs ([848430e](https://github.com/Luca-Timo/picpeak/commit/848430e72b39f61a78e3f967770abe6df9a730f2))
* **ci:** pin TRIVY_PLATFORM per matrix arch (post-[#477](https://github.com/Luca-Timo/picpeak/issues/477) follow-up) ([6750f5d](https://github.com/Luca-Timo/picpeak/commit/6750f5d3b06f6312629e81c4c84100c572746b69))
* **ci:** pin TRIVY_PLATFORM per matrix arch (post-[#477](https://github.com/Luca-Timo/picpeak/issues/477) follow-up) ([c3256dc](https://github.com/Luca-Timo/picpeak/commit/c3256dc6bf49a2352dfe38b804d757683bb3ac22))
* **ci:** scan multi-arch images per-arch by digest, pin trivy-action ([#476](https://github.com/Luca-Timo/picpeak/issues/476)) ([1144e9d](https://github.com/Luca-Timo/picpeak/commit/1144e9d1625eb69d8e2a53b1a3aa1b515798fc80))
* **ci:** scan multi-arch images per-arch by digest, pin trivy-action ([#476](https://github.com/Luca-Timo/picpeak/issues/476)) ([caf0d61](https://github.com/Luca-Timo/picpeak/commit/caf0d618572b7fca0b28776ee13dcce2e0da0b99))
* **ci:** trivy-action tag is v0.36.0 (was 0.28.0 — does not exist) ([40e176c](https://github.com/Luca-Timo/picpeak/commit/40e176cb46b2286d64a998937357b9e31cfaf04d))
* **cms:** apply dark mode to CMS editor, public CMS, and admin modals ([d2a10f6](https://github.com/Luca-Timo/picpeak/commit/d2a10f6523655488267d6f68835d7adb46dcf962))
* **cms:** nl/pt/ru i18n + gate external_url in public response ([08d0462](https://github.com/Luca-Timo/picpeak/commit/08d046276bf259e8511b01415141f51b8484f967))
* **cms:** nl/pt/ru i18n + gate external_url in public response ([bce5c1f](https://github.com/Luca-Timo/picpeak/commit/bce5c1f725043965c2499515f18e93e9578bd204))
* **create-event:** branding-default theme survives eventTypes refetch ([d62c529](https://github.com/Luca-Timo/picpeak/commit/d62c529b0278a9ac790b22f46f49004df71112ea))
* **create-event:** branding-default theme survives eventTypes refetch ([#323](https://github.com/Luca-Timo/picpeak/issues/323)-B) ([37d487d](https://github.com/Luca-Timo/picpeak/commit/37d487db86fe9fc11facff6d2c0bb9a24e6f6277))
* **create-event:** re-apply Branding theme on stale→fresh settings ([#323](https://github.com/Luca-Timo/picpeak/issues/323)-B) ([401abf7](https://github.com/Luca-Timo/picpeak/commit/401abf7a27cb73dd7fb8399f4c05644c95767093))
...
* **customer-portal:** post-merge fixes for event save, theme fonts, and customer→gallery handoff ([9776d8a](https://github.com/Luca-Timo/picpeak/commit/9776d8a6fcccb5e19e7c652b7e47557213d85731))
* **customer-routes:** Cache-Control: no-store on customer endpoints ([#470](https://github.com/Luca-Timo/picpeak/issues/470)) ([3122dd0](https://github.com/Luca-Timo/picpeak/commit/3122dd08a8bc08deb937236aaa3f750119a979b9))
* **customer:** customer sidebar active state matches admin pattern ([8d9d0be](https://github.com/Luca-Timo/picpeak/commit/8d9d0bea836e80870c343220b1c253844ac01590))
...
* **customer:** preserve slug-scoped gallery tokens on auth provider mount ([7ac1d14](https://github.com/Luca-Timo/picpeak/commit/7ac1d1473860796ea0925dd77454218f2b1f0020))
* **customer:** unwrap /customer/* from RequireFeature gate ([da08a58](https://github.com/Luca-Timo/picpeak/commit/da08a5828ab855365a2a2a6f4854b09eb409907a))
* **database-backup:** Postgres-safe insert destructure (runs the inli… ([ccc1d73](https://github.com/Luca-Timo/picpeak/commit/ccc1d73e91d6195362cbe490f2156abd53a04945))
...
* **docker:** chown /backup mount to nodejs on container startup ([83dfdc8](https://github.com/Luca-Timo/picpeak/commit/83dfdc82f24bc419a0d62b8554d1bfb0ce3f0335))
...
* **docker:** install system ffmpeg on Alpine, drop broken bundled binary ([3ab8a64](https://github.com/Luca-Timo/picpeak/commit/3ab8a64a24f1600e674f77d39139e33857b4dfc8))
* **docker:** install system ffmpeg on Alpine, drop broken bundled binary ([96818c7](https://github.com/Luca-Timo/picpeak/commit/96818c7ae8de0d8fd478cd901ea25a3272eee85d))
* **downloads:** apply original-filename toggle to individual downloads too ([#507](https://github.com/Luca-Timo/picpeak/issues/507)) ([38343e6](https://github.com/Luca-Timo/picpeak/commit/38343e62ded3d65efcea5c74b7c1e169807754d6))
...
* **email:** parse JSON-encoded language setting before using as locale ([ebc7da2](https://github.com/Luca-Timo/picpeak/commit/ebc7da21bea90ff84f5351bef4fd3c2605d3a68f))
* **email:** parse JSON-encoded language setting before using as locale ([f12062f](https://github.com/Luca-Timo/picpeak/commit/f12062f1e7be2974addbc50923f4427d3fba5a1c))
* **email:** render conditionals, localise password placeholders, fix caller/template variable drift ([0767203](https://github.com/Luca-Timo/picpeak/commit/07672038d4ac31fc601adfb2338104223856ba71))
* **email:** render conditionals, localise password placeholders, fix caller/template variable drift ([e8052ad](https://github.com/Luca-Timo/picpeak/commit/e8052adf1d2f1717652ac5d6b8cd8bcc01787189))
* **event:** correct updating client access ([d00f6fa](https://github.com/Luca-Timo/picpeak/commit/d00f6fa7de59bdbd30efe9ce824e795cf05616f4))
* **event:** ensure client share token is generated only when necessary ([916580a](https://github.com/Luca-Timo/picpeak/commit/916580adefd464417729e418aa1727b67566fea3))
* **events:** admin-set password on reset, full-URL gallery_link in all emails ([0d1f82d](https://github.com/Luca-Timo/picpeak/commit/0d1f82d31a2f9e30bf193496ac203eaf8dfd856b))
* **events:** admin-set password on reset, full-URL gallery_link in all emails ([ff50c74](https://github.com/Luca-Timo/picpeak/commit/ff50c74e1912ccba60f7ccdbead92b76de91388b))
* **events:** admins can clear expiration on edit even when 'Require expiration' is ON ([#426](https://github.com/Luca-Timo/picpeak/issues/426)) ([3fd8af3](https://github.com/Luca-Timo/picpeak/commit/3fd8af3d56b54f81cc20b75109cc212d23fc84c1))
* **events:** admins can clear expiration on edit even when "Require expiration" is ON ([#426](https://github.com/Luca-Timo/picpeak/issues/426)) ([e544561](https://github.com/Luca-Timo/picpeak/commit/e54456135cc8605fad949a955261cecc3f986355))
* **events:** clamp page state when totalPages drops below current page ([#442](https://github.com/Luca-Timo/picpeak/issues/442)) ([b4e30a4](https://github.com/Luca-Timo/picpeak/commit/b4e30a4293c77e6dc34e955741ee113b9d530718))
* **events:** clamp page state when totalPages drops below current page ([#442](https://github.com/Luca-Timo/picpeak/issues/442)) ([9c4a96f](https://github.com/Luca-Timo/picpeak/commit/9c4a96fe977b7a0907f5dea99491385195b76184))
* **events:** coerce expires_in_days to Number before addDays ([e5712d8](https://github.com/Luca-Timo/picpeak/commit/e5712d8ffe2f0ed980e1df5e1263876af7202b76))
* **events:** coerce expires_in_days to Number before addDays ([db29d0e](https://github.com/Luca-Timo/picpeak/commit/db29d0e2788f63cc9eb0a43ec58313387acb0c0d))
* **events:** CustomerAccountPicker hooks order crashed /admin/events/new ([2a7ae07](https://github.com/Luca-Timo/picpeak/commit/2a7ae0702dfc56e69bf845ded19888c29519414a))
* **events:** match scrollbar to theme in external folder tree picker ([bd42ee1](https://github.com/Luca-Timo/picpeak/commit/bd42ee1ce03b8f6e7b011b53f2c71453be931cc6))
...
* **events:** stop mapping branding_logo_position onto hero_logo_position ([af2b062](https://github.com/Luca-Timo/picpeak/commit/af2b0628cb4f79a147366665d35c098012071216))
* **events:** stop mapping branding_logo_position onto hero_logo_position ([ef1c875](https://github.com/Luca-Timo/picpeak/commit/ef1c875f6ec1e02657006cb09cd0b1d868ec2fc0))
* **events:** strip customer_account_ids from update spread ([dde72a1](https://github.com/Luca-Timo/picpeak/commit/dde72a1b1b3154e3effb9166291fdb8d59f16207))
* **events:** TDZ ReferenceError on /admin/events from [#442](https://github.com/Luca-Timo/picpeak/issues/442) fix ([#454](https://github.com/Luca-Timo/picpeak/issues/454)) ([2f63188](https://github.com/Luca-Timo/picpeak/commit/2f63188a345ce8e337723045a60b3a9306a9a840))
* **events:** typed-DELETE confirmation for bulk delete ([#417](https://github.com/Luca-Timo/picpeak/issues/417)) ([e165ee5](https://github.com/Luca-Timo/picpeak/commit/e165ee5d9fa805c704a64f91c9514bf0ab75b5b8))
* **events:** typed-DELETE confirmation for bulk delete ([#417](https://github.com/Luca-Timo/picpeak/issues/417)) ([99e420b](https://github.com/Luca-Timo/picpeak/commit/99e420b1b9783a1d6b4eb892c09d0af3340bf314))
* **external-media:** pre-generate thumbnails so reference-mode galleries load fast ([#423](https://github.com/Luca-Timo/picpeak/issues/423)) ([e2ffd9f](https://github.com/Luca-Timo/picpeak/commit/e2ffd9f93d228f9e16408fe424c65b26db67ac8e))
* **external-media:** pre-generate thumbnails so reference-mode galleries load fast ([#423](https://github.com/Luca-Timo/picpeak/issues/423)) ([f3d0f16](https://github.com/Luca-Timo/picpeak/commit/f3d0f161c9e554a5149e6b4eafdb0ac42bebf277))
* **features-tab:** icon tiles + preview pills follow CI accent ([15d01f3](https://github.com/Luca-Timo/picpeak/commit/15d01f375628d3c1ead05d48a09c6509c508a848))
...
* **feedback:** three guest-mode bugs from [#538](https://github.com/Luca-Timo/picpeak/issues/538) (filter, like state, count leak) ([c900be9](https://github.com/Luca-Timo/picpeak/commit/c900be92dd490b21aabb10fd56b6fbc3da444ee0))
* **feedback:** three guest-mode bugs reported in [#538](https://github.com/Luca-Timo/picpeak/issues/538) ([5311588](https://github.com/Luca-Timo/picpeak/commit/5311588baf3c6acfc971cb014a142d6b4b153aa1))
* **fonts:** drop immutable Cache-Control to allow font replacement rollout ([5703fcb](https://github.com/Luca-Timo/picpeak/commit/5703fcb80680155e3b637dd5fc15c430de963c40))
* **gallery:** default controls to inline for every layout ([045e9ea](https://github.com/Luca-Timo/picpeak/commit/045e9ea4861f33e3e82e31f978ac297c7f7824f6))
* **gallery:** hide Like button when guest feedback is off ([#506](https://github.com/Luca-Timo/picpeak/issues/506)) ([9d2db9a](https://github.com/Luca-Timo/picpeak/commit/9d2db9a73b71967fe4658c53d29ef5984f20bc69))
* **gallery:** preserve sidebar controlsStyle on banner migration ([05dadff](https://github.com/Luca-Timo/picpeak/commit/05dadff4934ad9b055de8875846c2a7175e16f86))
* **gallery:** serve thumbnails / photos / hero via storage abstraction ([#432](https://github.com/Luca-Timo/picpeak/issues/432)) ([d3007b0](https://github.com/Luca-Timo/picpeak/commit/d3007b0dd29d37a46ce26e8b4eb15908e0f8e3d2))
* **gallery:** serve thumbnails / photos / hero via storage abstraction ([#432](https://github.com/Luca-Timo/picpeak/issues/432)) ([83d79f4](https://github.com/Luca-Timo/picpeak/commit/83d79f4d39f2a68c8cb905cbd1b46d53bba80f49))
* **gallery:** WCAG-safe Download button text + extract HeaderDownloadButton ([#401](https://github.com/Luca-Timo/picpeak/issues/401) follow-ups) ([04e928d](https://github.com/Luca-Timo/picpeak/commit/04e928d7621743d9d99797f0996f8c7aa50e7b2d))
* **gallery:** WCAG-safe Download button text + extract HeaderDownloadButton ([#401](https://github.com/Luca-Timo/picpeak/issues/401) follow-ups) ([0c80abd](https://github.com/Luca-Timo/picpeak/commit/0c80abd57b806b9df01429a093c30c12c80c0601))
* **header:** hide language name on mobile to free the title ([#523](https://github.com/Luca-Timo/picpeak/issues/523)) ([4b4ecfd](https://github.com/Luca-Timo/picpeak/commit/4b4ecfdf7143c8f353355ecd6d5ee14bbf50c9bb))
...
* **i18n:** drive customer "Preferred language" select from SUPPORTED_LANGUAGES ([#510](https://github.com/Luca-Timo/picpeak/issues/510)) ([51890e1](https://github.com/Luca-Timo/picpeak/commit/51890e1aa5bacb5cfb5c9dc6e59770bd18406a66))
* **i18n:** settings page resets UI language to server default ([482e91b](https://github.com/Luca-Timo/picpeak/commit/482e91bbf8b8deee361ffc8b031094fb99cc569d))
* **import:** capture photo dimensions in fileWatcher + s3AutoImporter ([#447](https://github.com/Luca-Timo/picpeak/issues/447)) ([5b14854](https://github.com/Luca-Timo/picpeak/commit/5b148542e6f2396ce47e3b6c301f186f9af9adec))
* **import:** capture photo dimensions in fileWatcher + s3AutoImporter ([#447](https://github.com/Luca-Timo/picpeak/issues/447)) ([936a277](https://github.com/Luca-Timo/picpeak/commit/936a277eb8695a54e65eaaa5a75ce43cff54c5db))
* **install:** defer events.hero_photo_id FK to break circular reference ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([62b3ed6](https://github.com/Luca-Timo/picpeak/commit/62b3ed636414d358c0c73712b732207fc6fa1200))
* **install:** defer events.hero_photo_id FK to break circular reference ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([87834a7](https://github.com/Luca-Timo/picpeak/commit/87834a7fff57a53bb1060ad7061dd6d279922f42))
* **install:** drop racy migration step + add missing frontend container ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([d4155c4](https://github.com/Luca-Timo/picpeak/commit/d4155c46117eb1db6255ebac0ea47e6fc3e99801))
* **install:** self-chowning entrypoint kills fresh-install restart loop ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([42c5cda](https://github.com/Luca-Timo/picpeak/commit/42c5cda38c0deeb4e61554e9e4a913bd5cd0b980))
* **install:** self-chowning entrypoint kills fresh-install restart loop ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([1505775](https://github.com/Luca-Timo/picpeak/commit/15057756788eacc75dd9ff64541cac7418f368f2))
* **install:** silence clean-install postgres log noise ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([99e60a2](https://github.com/Luca-Timo/picpeak/commit/99e60a243321a06f659d811babbcda9ffef655c4))
* **install:** silence clean-install postgres log noise ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([86b33d4](https://github.com/Luca-Timo/picpeak/commit/86b33d4ddaf98e1f32473832b0f89565750174e5))
* **install:** silence pg healthcheck noise + drop legacy workers container ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([d39406b](https://github.com/Luca-Timo/picpeak/commit/d39406b2414cdfcae84e8175d90821dd3a5287bb))
* **install:** silence pg healthcheck noise + drop legacy workers container ([#484](https://github.com/Luca-Timo/picpeak/issues/484)) ([0b0b1bb](https://github.com/Luca-Timo/picpeak/commit/0b0b1bb2d529dbaae8e49891d8d5e8019b971838))
* **install:** skip legacy chain on recovery-state DBs + schema-drift CI ([#530](https://github.com/Luca-Timo/picpeak/issues/530)) ([a0ebc97](https://github.com/Luca-Timo/picpeak/commit/a0ebc97cdd871041ff3cfdcc7276c413ac89d24f))
...
* **lightbox:** align swipe-neighbour height + stop black flash on commit ([#505](https://github.com/Luca-Timo/picpeak/issues/505)) ([d2d5509](https://github.com/Luca-Timo/picpeak/commit/d2d55098d6d899c74b3b32b46b8194d06e7cda7e))
...
* **lightbox:** fill the heart icon when liked ([#538](https://github.com/Luca-Timo/picpeak/issues/538) follow-up) ([3e39112](https://github.com/Luca-Timo/picpeak/commit/3e39112a1276c194259d936dad813f3b0fc2dc3f))
* **lightbox:** fill the heart icon when liked ([#538](https://github.com/Luca-Timo/picpeak/issues/538) follow-up) ([600c29d](https://github.com/Luca-Timo/picpeak/commit/600c29db8a75fa44e72da55bc5288908de614d9d))
* **lightbox:** hide comments toggle when allow_comments=false ([#518](https://github.com/Luca-Timo/picpeak/issues/518)) ([d44e1ad](https://github.com/Luca-Timo/picpeak/commit/d44e1adba7a444b03511e9402cd39d25fe5acafe))
* **lightbox:** pan zoomed image with single-finger touch on mobile ([#532](https://github.com/Luca-Timo/picpeak/issues/532)) ([53139b8](https://github.com/Luca-Timo/picpeak/commit/53139b8cb87e0669fe38089f38848a59ce3cbb28))
...
* **nginx:** honour outer X-Forwarded-Proto when behind a reverse proxy ([#547](https://github.com/Luca-Timo/picpeak/issues/547)) ([b351d17](https://github.com/Luca-Timo/picpeak/commit/b351d17ee99528dd4251e74dfc47cd1fe289d9c3))
* **nginx:** honour outer X-Forwarded-Proto when behind a reverse proxy ([#547](https://github.com/Luca-Timo/picpeak/issues/547)) ([5488de3](https://github.com/Luca-Timo/picpeak/commit/5488de3383d33d8a037587dd9112d36ea035c465))
* **nginx:** proxy /fonts requests to backend ([e6c03e4](https://github.com/Luca-Timo/picpeak/commit/e6c03e4b6e4ee2ccc3e3cd8b7a54c18f9685c2ba))
* **og:** brandable static title + wider crawler UA coverage ([#521](https://github.com/Luca-Timo/picpeak/issues/521)) ([b960639](https://github.com/Luca-Timo/picpeak/commit/b96063903513fcc4cbe0e72f59ccbc37d7b1c0ab))
* **promo-banner:** center by default + admin alignment selector ([#482](https://github.com/Luca-Timo/picpeak/issues/482)) ([d1034ce](https://github.com/Luca-Timo/picpeak/commit/d1034ce1c65c31b06005cfd0c047dba3251579ab))
* **promo-banner:** center by default + admin alignment selector ([#482](https://github.com/Luca-Timo/picpeak/issues/482)) ([a803491](https://github.com/Luca-Timo/picpeak/commit/a803491cf477c0d62e23d6a019e0d252e2c537f8))
* **public-site:** honor dark theme surface colors ([8b72721](https://github.com/Luca-Timo/picpeak/commit/8b727218127db2a738ad5a4381358076c1575c8a))
...
* recover three orphaned commits from [#527](https://github.com/Luca-Timo/picpeak/issues/527) (BRAND_TITLE runtime, Web Share, pan zoom) ([9607b46](https://github.com/Luca-Timo/picpeak/commit/9607b4666c0abf22e54b43be3e87e3243db2cdbc))
...
* **restore:** coerce pg bigint counts to Number before comparing (PR … ([8fb91f4](https://github.com/Luca-Timo/picpeak/commit/8fb91f4af4627b31ab6411846edef04932321a1b))
...
* **restore:** default restore_allow_force=true + auto-upgrade existin… ([3294487](https://github.com/Luca-Timo/picpeak/commit/32944877d75d8d01962643bd7aa89355321e7be0))
...
* **restore:** discover backups from disk, not just the DB ([7bde092](https://github.com/Luca-Timo/picpeak/commit/7bde092da2db200c6410facdb2e739da7a18ab17))
...
* **restore:** DROP/CREATE DATABASE needs explicit -d maintenance DB ([c193284](https://github.com/Luca-Timo/picpeak/commit/c193284c022986ee2f4ecad04f2ea49074a2425d))
...
* **restore:** evict active sessions before dropping target DB ([60084b4](https://github.com/Luca-Timo/picpeak/commit/60084b4f6efe08c06a2672d60e8148a43220253e))
...
* **restore:** move operator-meta replay after post-restore verificati… ([72751c2](https://github.com/Luca-Timo/picpeak/commit/72751c2db10d50ba2865774fbf68ace051f8dc15))
...
* **restore:** re-sync PostgreSQL sequences after psql load ([6eafa4a](https://github.com/Luca-Timo/picpeak/commit/6eafa4a6198161be823e586db8511e244ea10b77))
* **restore:** resolve 'local' source to backup_destination_path ([80e490b](https://github.com/Luca-Timo/picpeak/commit/80e490b28713d9e54f81d4925db5eb7a3584837a))
...
* **restore:** resolve local source + always rollback on failure ([dc5142f](https://github.com/Luca-Timo/picpeak/commit/dc5142f80d8e9bdbf208d7c6d70a7bb926b80cb9))
...
* **restore:** set was_successful=true on the completed update ([2f5f8ab](https://github.com/Luca-Timo/picpeak/commit/2f5f8ab3e2fad3a183dd6249e084bf1ae9795143))
...
* **safe-exec:** Node 22-compatible stdio + error-bridge for spawnTo/F… ([b722076](https://github.com/Luca-Timo/picpeak/commit/b722076e51a51fb222547e1d94228444105fd746))
...
* **security:** patch 18 dependency CVEs (axios + transitives + nodemailer + i18next-http-backend) ([b7d6ca0](https://github.com/Luca-Timo/picpeak/commit/b7d6ca0b65e652b50d957380f93ed16e151e94a8))
* **security:** patch 18 dependency CVEs (axios + transitives) ([523f499](https://github.com/Luca-Timo/picpeak/commit/523f49916bea44697d40f61e0b6e44b83decc4b9))
* **security:** scan triage cleanup — drop dead deps, harden Docker/nginx/postMessage ([7abfeb9](https://github.com/Luca-Timo/picpeak/commit/7abfeb91cc7bbb9b6853146dbfe16b8d9835bcb3))
* **security:** scan triage cleanup — drop dead deps, harden Docker/nginx/postMessage ([6b6191a](https://github.com/Luca-Timo/picpeak/commit/6b6191a4260650e21c45f6153cac1b142bf8483a))
* **server:** drop missing requireCustomerPortal middleware import ([4fa7225](https://github.com/Luca-Timo/picpeak/commit/4fa72257329942a6b598fa90c83c6bca7586fe33))
* **server:** mount /api/admin/feature-flags route ([f048011](https://github.com/Luca-Timo/picpeak/commit/f048011324bfa4cee8f89b0131b68dd520446ca2))
* settings page resets UI language to server default ([165ebce](https://github.com/Luca-Timo/picpeak/commit/165ebce8d1226cde22a36df28c0c45c2d79e2423))
* **settings:** neutralize sidebar icons for a consistent palette ([2f00bbd](https://github.com/Luca-Timo/picpeak/commit/2f00bbdd90ef38feca886e834e753d4c4b60c11d))
* **settings:** readable contrast on accent-tinted icon tiles + pills ([bf7ef14](https://github.com/Luca-Timo/picpeak/commit/bf7ef14626dc3a0e18f20813abe2a101d02c6d5b))
* **test-infra:** scope databaseBackup fs.unlink stub so it doesn't leak ([06597ef](https://github.com/Luca-Timo/picpeak/commit/06597ef1b37493413915fc3272c538946b283f0b))
...
* **test-infra:** unref sessionTimeout cleanup interval so workers exi… ([ad9fd09](https://github.com/Luca-Timo/picpeak/commit/ad9fd09c7e5366c350ba568f6519e18003cd64bf))
...
* **theme:** 'Same as body' heading font no longer inherits stale value ([35f5b86](https://github.com/Luca-Timo/picpeak/commit/35f5b86d0f6a56627aac2abfe5228b5935709b08))
* **theme:** centralise force-mode enforcement inside ThemeContext so every gallery flips ([21188f4](https://github.com/Luca-Timo/picpeak/commit/21188f48d76dd29bc1251bcc6faf9d6d96c805b5))
* **theme:** kill initial white frame + theme-aware skeleton tiles ([#358](https://github.com/Luca-Timo/picpeak/issues/358) follow-up) ([f529c9e](https://github.com/Luca-Timo/picpeak/commit/f529c9e3d72f0e3496951dfa5d160afda9a1ac51))
* **theme:** kill initial white frame + theme-aware skeleton tiles ([#358](https://github.com/Luca-Timo/picpeak/issues/358) follow-up) ([1a530ae](https://github.com/Luca-Timo/picpeak/commit/1a530aeaa2d61b34d9721a555b71631c7101c58e))
* **theme:** pre-React bootstrap to kill white-flash on dark galleries ([#358](https://github.com/Luca-Timo/picpeak/issues/358)) ([07b41e6](https://github.com/Luca-Timo/picpeak/commit/07b41e691d2e8a71f775c667d805a2f9adc10590))
* **theme:** pre-React bootstrap to kill white-flash on dark galleries ([#358](https://github.com/Luca-Timo/picpeak/issues/358)) ([f81a872](https://github.com/Luca-Timo/picpeak/commit/f81a8728e67b313ac43f55c94fb635abf9beca05))
* **upload:** restore configurable batch-size for reverse proxies ([#509](https://github.com/Luca-Timo/picpeak/issues/509)) ([98f3c3d](https://github.com/Luca-Timo/picpeak/commit/98f3c3df4184b6d59b6c6b8e5f11b12b362320af))
* **upload:** wire drag-and-drop on admin + user upload zones ([#504](https://github.com/Luca-Timo/picpeak/issues/504)) ([577c4bd](https://github.com/Luca-Timo/picpeak/commit/577c4bdf29e107d11044a218ed5a6ba359e060c7))


### Reverts

* **branding:** per-option font preview (defer to follow-up) ([f410207](https://github.com/Luca-Timo/picpeak/commit/f410207b2d7ddf1c9525603c7dcbb7cdfee1729b))
...
* **docker:** drop /backup chown from wait-for-db.sh ([0983a44](https://github.com/Luca-Timo/picpeak/commit/0983a440195d7b7a91312caf8ce1c573d1d6b403))
...
* consolidate disaster-recovery into Backup & Restore guide ([e427bc7](https://github.com/Luca-Timo/picpeak/commit/e427bc77147e99781e2dbde6cd3f33da3a94a811))
...
* **contributing:** update branch reference from main to beta ([ed37caf](https://github.com/Luca-Timo/picpeak/commit/ed37caf3d898d9b2db985e6c6ff203457fd4aa38))
* **contributing:** update branch reference from main to beta ([c114749](https://github.com/Luca-Timo/picpeak/commit/c1147499212ef64e9d8ded89c38d84ab0adc5346))
...
* **fonts:** cache rollout, stale-list note, meta.json ([bd0e052](https://github.com/Luca-Timo/picpeak/commit/bd0e052b1a1847718151a16117dacc6c42a2178e))
* **localization:** enhance French language support and improve i18next configuration ([d1bc5e0](https://github.com/Luca-Timo/picpeak/commit/d1bc5e030f55c15bf09f37b97f8e1608578a2395))
* **readme:** add Contributors section with @Luca-Timo and @Rekoo-PS ([c60ab74](https://github.com/Luca-Timo/picpeak/commit/c60ab74ae2daabc4b11fea1f1b2df728294b03c8))
* **readme:** add Contributors section with @Luca-Timo and @Rekoo-PS ([dbe0a30](https://github.com/Luca-Timo/picpeak/commit/dbe0a3055bd2c71981cb7d9cf43c2b22b9e3276c))
