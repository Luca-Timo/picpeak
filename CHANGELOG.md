...
## [3.77.0-beta.0](https://github.com/Luca-Timo/picpeak/compare/v3.76.2-beta.0...v3.77.0-beta.0) (2026-07-02)
...
* **setup:** auto-generate JWT/DB/Redis secrets on first run ([0ac8462](https://github.com/Luca-Timo/picpeak/commit/0ac84623135cb5335bd5c0af99425dcc1ef33a90))
* **setup:** gate the legacy default-admin seed behind ADMIN_PASSWORD ([966c753](https://github.com/Luca-Timo/picpeak/commit/966c75398ed8a6e69751547d6cf292594de6fdcf))
* **setup:** gate the legacy default-admin seed behind ADMIN_PASSWORD ([e6439cc](https://github.com/Luca-Timo/picpeak/commit/e6439cc02ddfca395cbd6ce99f0624b3c44eacc2))
* **setup:** gate the legacy default-admin seed behind ADMIN_PASSWORD ([e328019](https://github.com/Luca-Timo/picpeak/commit/e3280193080986bacfed479058b3fcbf9cccf3a4))
* **setup:** in-browser first-run admin bootstrap (no ADMIN_PASSWORD) ([85916ad](https://github.com/Luca-Timo/picpeak/commit/85916adaf1b723046300b21833e8d232037e75ab))
* **setup:** print the one-time setup token to stdout at end of boot ([948ad31](https://github.com/Luca-Timo/picpeak/commit/948ad3157276dca7cff095ccbfacd2a52bac4362))
...
* **setup:** address PR [#714](https://github.com/Luca-Timo/picpeak/issues/714) review — password UX, script token, race, nits ([c1af7d6](https://github.com/Luca-Timo/picpeak/commit/c1af7d6bd1fe6b22453fa159cb03987b1edd11c6))
* **setup:** JSON-stringify the setup token for the app_settings jsonb column ([12a7814](https://github.com/Luca-Timo/picpeak/commit/12a78145b986ebb117b1fdb7e3390f911f4b98a8))
* **setup:** make secrets-init robust + escape $ so .env-set values win ([1f2ef10](https://github.com/Luca-Timo/picpeak/commit/1f2ef104d91e2495eb3265c3075c51221d4f2a91))
* **setup:** remove the SETUP_TOKEN file when the token is cleared/burned ([c4de64b](https://github.com/Luca-Timo/picpeak/commit/c4de64b386af83cf31cdfe28958b93b57885853d))
* **setup:** run token hook after install-from-backup; drop an any cast ([7bf6d39](https://github.com/Luca-Timo/picpeak/commit/7bf6d39a5115c138fb3650feed68827915ae1205))
...
* **readme:** quickstart no longer requires editing .env (secrets auto-generate) ([a1d5ad5](https://github.com/Luca-Timo/picpeak/commit/a1d5ad582ebe7053df2f4555e66cd2935b5c159f))
