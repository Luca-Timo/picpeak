...
## [3.73.0-beta.0](https://github.com/Luca-Timo/picpeak/compare/v3.72.0-beta.0...v3.73.0-beta.0) (2026-06-29)
...
* **admin/users:** reactivate + delete actions for deactivated admin users ([c4a9b36](https://github.com/Luca-Timo/picpeak/commit/c4a9b3636fc7a9209ae724acb7c8cffe141d93ea))
* **admin/users:** reactivate + delete actions for deactivated admin users ([dfcebcc](https://github.com/Luca-Timo/picpeak/commit/dfcebccee98a551980ad2be78a8356fd39894f8a))
* **admin:** clickable version links + update-available modal with changelog & upgrade command ([48cf112](https://github.com/Luca-Timo/picpeak/commit/48cf1121e546e112cd37d94f7924a808c020dd8f))
* **admin:** link version numbers in sidebar to GitHub release notes ([#566](https://github.com/Luca-Timo/picpeak/issues/566)) ([d231623](https://github.com/Luca-Timo/picpeak/commit/d231623c59498ae56e13bee45a70100423053e9b))
...
* **admin:** update-available modal with aggregated changelog + upgrade command ([#567](https://github.com/Luca-Timo/picpeak/issues/567)) ([832f7ba](https://github.com/Luca-Timo/picpeak/commit/832f7bad450112dca697b959644e259328a6cfa9))
...
* **backup:** admin endpoint to verify CRM document-artefact integrity ([4812fcd](https://github.com/Luca-Timo/picpeak/commit/4812fcdec38d7bfdbb5eac80eb6fe004f405b970))
* **backup:** config-driven walker via backup_paths table ([302fc6b](https://github.com/Luca-Timo/picpeak/commit/302fc6b9371ff08ee2d2157325d4603b00b5f7b4))
* **backup:** coverage diagnostic — what will the next backup miss? ([03e6617](https://github.com/Luca-Timo/picpeak/commit/03e6617f38344434add3bb866e13807f19940519))
* **backup:** UI for backup-integrity verifier — tab + post-restore CTA ([7e2feca](https://github.com/Luca-Timo/picpeak/commit/7e2feca12f894a9d02193d85634e69d76710fc14))
...
* CRM module — quotes, contracts, invoices, hours, calendar, tax ([5f0fcc2](https://github.com/Luca-Timo/picpeak/commit/5f0fcc225c29ce0f4410c5aba5ecd5a3a6d07259))
...
* **crm:** add event_reminder_* templates to dev email tester ([6d302e7](https://github.com/Luca-Timo/picpeak/commit/6d302e79983f73696f24ab1dfa71fd7f4f6345ca))
* **crm:** allow negative line items for manual discount/Rabatt rows ([3d37324](https://github.com/Luca-Timo/picpeak/commit/3d373240802869ae3d181b9cf67d70335809408d))
...
* **crm:** i18n EN + DE for CRM, machine fr/nl/pt/ru fallbacks ([409d414](https://github.com/Luca-Timo/picpeak/commit/409d41403557b28560380a9badfb4c576d1df330))
...
* **crm:** route billing docs to billing_email when set ([09c5110](https://github.com/Luca-Timo/picpeak/commit/09c5110d2b9cc8f2589731c60163897329ab4222))
...
* **crm:** unlock reminderEmails feature flag in Features tab ([b064aab](https://github.com/Luca-Timo/picpeak/commit/b064aab8ef1230cfc5f42cbdb430e55676d96d3e))
* **dashboard:** revenue "year" tile toggles 365 days ↔ calendar YTD ([5096602](https://github.com/Luca-Timo/picpeak/commit/5096602b81fedc00e60a13d393abd2376f423522))
...
* **i18n:** add Slovenian (sl) language support ([433af15](https://github.com/Luca-Timo/picpeak/commit/433af1514687b5c103e72db800954f96fd42b9b8))
* **i18n:** add Slovenian (sl) language support ([37cc363](https://github.com/Luca-Timo/picpeak/commit/37cc3631d8285ba9d72f0d01f37267a903f2d3e7))
...
* **invoices:** surface monthly/manual accumulator drafts in the Bills list ([2ba6dc4](https://github.com/Luca-Timo/picpeak/commit/2ba6dc40ca6870a7f4ffb2f630f0f828a7df4c16))
* **lightbox:** multi-photo Web Share save-to-Photos on iOS ([#557](https://github.com/Luca-Timo/picpeak/issues/557)) ([d5823c7](https://github.com/Luca-Timo/picpeak/commit/d5823c79d9a187461c0126adcff7f4374cd0e8aa))
...
* **restore:** self-heal restore_allow_force default ON at boot ([dbcecfe](https://github.com/Luca-Timo/picpeak/commit/dbcecfe2aa6629a0665150e56c6306287c6fd225))
...
* **workflows:** wire booking document actions (prepare_invoice/contr… ([53018a8](https://github.com/Luca-Timo/picpeak/commit/53018a8f55b634cb017fcc6ad468579a027c62ff))
...
* **admin-header:** truncate long company names on narrow widths ([#523](https://github.com/Luca-Timo/picpeak/issues/523) regression) ([e7cf834](https://github.com/Luca-Timo/picpeak/commit/e7cf834325e8686613fbbee78d52213cb3ba98b1))
* **admin-ui:** backup download button hits API path, not SPA route ([ed7ab61](https://github.com/Luca-Timo/picpeak/commit/ed7ab61b90aac95da132e74468cf19ef7f0f8a46))
...
* **api/v1/events:** honour global devtools-detection default on create ([#592](https://github.com/Luca-Timo/picpeak/issues/592)) ([2304b25](https://github.com/Luca-Timo/picpeak/commit/2304b2562465f8c86c82f2155fbdce264e68fdb3))
...
* **backup-dashboard:** show last SUCCESSFUL backup + last attempt separately ([155aa63](https://github.com/Luca-Timo/picpeak/commit/155aa631035ab62a1aed5ca052b7eb7c57b431e4))
* **backup-history:** show Total + Other so per-row sums match the count ([7f7c8ee](https://github.com/Luca-Timo/picpeak/commit/7f7c8eee61f7a721e65c0409aaf2028e2fb58c37))
...
* **backup:** include storage/business-docs/ in the in-app backup walker ([a9280ea](https://github.com/Luca-Timo/picpeak/commit/a9280ea9bac731199133a34ede5a89359bcde89e))
* **backup:** inline DB dump + fail-loud guard so "Run Backup Now" can't ship files-only ([7fdf01a](https://github.com/Luca-Timo/picpeak/commit/7fdf01ad21da70ae534867e15ae2af1afd4899f4))
* **backup:** inline DB dump + fail-loud guard so "Run Backup Now" can't ship files-only ([7c230bd](https://github.com/Luca-Timo/picpeak/commit/7c230bdc242fa99e12e42c5fb6ee9202243a36e7))
...
* **crm:** self-heal missing CRM email templates at boot + recover queue ([83933ba](https://github.com/Luca-Timo/picpeak/commit/83933baeecdc7e0272f2da0ff79fb1fb33bea114))
* **crm:** thread trx through sequence-claim sites to unblock SQLite ([d1aecaa](https://github.com/Luca-Timo/picpeak/commit/d1aecaa1804c0039744eb79a4032d1ed923e0b85))
* **csp:** external bootstrap script to survive strict reverse-proxy CSP ([#564](https://github.com/Luca-Timo/picpeak/issues/564)) ([dcc629c](https://github.com/Luca-Timo/picpeak/commit/dcc629cad23ce0ca89aabb6f8b1eacfde599774e))
* **database-backup:** Postgres-safe insert destructure (runs the inline dump) ([f741e88](https://github.com/Luca-Timo/picpeak/commit/f741e88acbaf6135be575dc7f42b80bce735abad))
...
* **docker:** chown /backup mount to nodejs on container startup ([3ab3756](https://github.com/Luca-Timo/picpeak/commit/3ab3756a56dc8c3bcd517d2d60c7ffd10688a945))
...
* **email:** preserve dots + subaddresses across all normalization sites ([de9a924](https://github.com/Luca-Timo/picpeak/commit/de9a924c77faebc2d0c1ff230a52d8da313259e8))
* **email:** preserve dots + subaddresses across all normalization sites ([#574](https://github.com/Luca-Timo/picpeak/issues/574)) ([075b45f](https://github.com/Luca-Timo/picpeak/commit/075b45f02050a694937d42e85fac10d65bb574dd))
...
* **events:** preserve branding inheritance when saving events with null color_theme ([d5a37df](https://github.com/Luca-Timo/picpeak/commit/d5a37df2c41425511dc8a1f974088bebb768f0d5))
...
* **gallery:** toggle (not add) the local liked set on click ([#590](https://github.com/Luca-Timo/picpeak/issues/590)) ([d292b9f](https://github.com/Luca-Timo/picpeak/commit/d292b9fa10bffe5d751629b900c606763fa8e73a))
...
* **i18n:** align quoteResponse.changeWithin DE placeholder with call site ([45f0606](https://github.com/Luca-Timo/picpeak/commit/45f0606ea318e21e43cb53f9674c1f7dd702e1e5))
...
* **invoices:** add bank transfer to the mark-paid method list ([d2cbe99](https://github.com/Luca-Timo/picpeak/commit/d2cbe992895596838067995ed5ee2f975222f711))
...
* **invoices:** badge held (unsent, no send date) invoices as "Draft" ([d77bed8](https://github.com/Luca-Timo/picpeak/commit/d77bed8375e5fb2bff912c37e9e73fcc5d22de5e))
* **invoices:** badge held (unsent, no send date) invoices as "Draft" ([730a103](https://github.com/Luca-Timo/picpeak/commit/730a10303ec2cca435de5259ebdcbe305e91ef7d))
* **invoices:** show "Draft" on the invoice detail page for accumulato… ([10c28e2](https://github.com/Luca-Timo/picpeak/commit/10c28e2b9e47ce7956c1ce3c7268ddab2e4a898e))
* **invoices:** show "Draft" on the invoice detail page for accumulator drafts ([53da27a](https://github.com/Luca-Timo/picpeak/commit/53da27ad3052c13802243ab4301e5a74822051ee))
...
* **lightbox+events:** Android download lag, multi-photo Web Share re-land, theme branding inheritance ([e016f51](https://github.com/Luca-Timo/picpeak/commit/e016f510b6cc57a9ed1b59e2ee24fedd5d7097c3))
* **lightbox:** eliminate download lag on Android by skipping the blob round-trip ([0479521](https://github.com/Luca-Timo/picpeak/commit/04795219a0b66fdd1ef73748d803adfdfc0d676f))
* **lightbox:** restrict Web Share save-to-Photos path to iOS ([#554](https://github.com/Luca-Timo/picpeak/issues/554)) ([578397b](https://github.com/Luca-Timo/picpeak/commit/578397bc6b27b56ccf3bf1f2f244e0e0053c493a))
* **lightbox:** restrict Web Share save-to-Photos path to iOS ([#554](https://github.com/Luca-Timo/picpeak/issues/554)) ([2a309c7](https://github.com/Luca-Timo/picpeak/commit/2a309c75a74be3af3eb67758f8d65f801ef3019a))
...
* **migrations:** defer cross-table FKs in 107_crm_consolidated ([88a6b34](https://github.com/Luca-Timo/picpeak/commit/88a6b34c5e8a48c9e6419554b8f813ae02f2e519))
* **nginx:** defensive large_client_header_buffers bump ([#591](https://github.com/Luca-Timo/picpeak/issues/591)) ([c83e883](https://github.com/Luca-Timo/picpeak/commit/c83e88348fbd473fb1de041cebabd3ace65d4d98))
...
* **quote-response:** compute minutes-remaining for the DE changeWithin string ([5ce0b6e](https://github.com/Luca-Timo/picpeak/commit/5ce0b6edc3fef41f2f22dd585a668f471ac47a2e))
* **reminders:** wrap is_active/is_archived wheres in formatBoolean ([0a1d8c8](https://github.com/Luca-Timo/picpeak/commit/0a1d8c863a46bede582eae2c1f96428604bd02fd))
* **restore-wizard:** surface failure status, stop showing "completed at 0%" ([47ed690](https://github.com/Luca-Timo/picpeak/commit/47ed6907d141de883e95377665fdd61527bba107))
* **restore-wizard:** warn on backups without a database dump ([989b42c](https://github.com/Luca-Timo/picpeak/commit/989b42c2f1c2cbf97c612fa790d1ae77d16e3626))
...
* **restore:** default restore_allow_force=true + auto-upgrade existing installs ([c435263](https://github.com/Luca-Timo/picpeak/commit/c435263744cf6a23b6cd9e0466cc8af3f6c4894a))
* **restore:** discover backups from disk, not just the DB ([f664fea](https://github.com/Luca-Timo/picpeak/commit/f664fea60ca223479b917abb7a256d4320f089e3))
* **restore:** DROP/CREATE DATABASE needs explicit -d maintenance DB ([4c31a22](https://github.com/Luca-Timo/picpeak/commit/4c31a22626db47bbbffadd823ae5129ff079faad))
* **restore:** evict active sessions before dropping target DB ([a39def6](https://github.com/Luca-Timo/picpeak/commit/a39def672ef054ed17fd2e65cec6ae90adf1d959))
...
* **restore:** re-init knex pool after DROP/CREATE DATABASE ([48e9c9c](https://github.com/Luca-Timo/picpeak/commit/48e9c9c79aa87b5e5450c76afd00b31de6597d6c))
* **restore:** resolve 'local' source to backup_destination_path ([44c7935](https://github.com/Luca-Timo/picpeak/commit/44c7935b8483be6aa9282c158cfa0d026f301808))
* **restore:** resolve local source + always rollback on failure ([5c0be66](https://github.com/Luca-Timo/picpeak/commit/5c0be66a14e4ad854b7e1325ff32a075b480cffd))
...
* **safe-exec:** Node 22-compatible stdio + error-bridge for spawnTo/FromFile ([d34036c](https://github.com/Luca-Timo/picpeak/commit/d34036c4efd7769ef4896107cc53ea1a4cd1fa84))
...
* **test-infra:** scope databaseBackup fs.unlink stub so it doesn't leak ([3f5d006](https://github.com/Luca-Timo/picpeak/commit/3f5d006625fdbd8f34ad57d901dd55f543878e05))
* **test-infra:** unref sessionTimeout cleanup interval so workers exit gracefully ([ecb2aea](https://github.com/Luca-Timo/picpeak/commit/ecb2aeacf9569bb2ea4d678a97c527234aefd159))
...
* **docker:** drop /backup chown from wait-for-db.sh ([5b3bfed](https://github.com/Luca-Timo/picpeak/commit/5b3bfed144e10a74c222b693095b55d77ee07816))
...
* **contributing:** note rebuild-after-package.json gotcha for dev compose ([2692e71](https://github.com/Luca-Timo/picpeak/commit/2692e71297925b7c117108fa9da9defe87dfe88e))
* **crm:** legal/financial disclaimers — examples only ([e7db0bb](https://github.com/Luca-Timo/picpeak/commit/e7db0bb8668a2cda9ee5469bcfb1a2e2cfd05403))
* list CRM under Beta Features + note dev-compose rebuild gotcha ([1ed4804](https://github.com/Luca-Timo/picpeak/commit/1ed48046cbba1df3710cee197943521aedd1fe3d))
...
* **readme:** list CRM module under Beta Features with own-risk disclaimer ([c2dcd9c](https://github.com/Luca-Timo/picpeak/commit/c2dcd9ca840b9c1905e75bd9b4b31b5c0b75043d))
* **release:** establish stable-channel cadence + promotion process ([e537923](https://github.com/Luca-Timo/picpeak/commit/e537923857b4b6000d715bba23a78f8685b44ee6))
* **release:** establish stable-channel cadence + promotion process ([#565](https://github.com/Luca-Timo/picpeak/issues/565)) ([ab81998](https://github.com/Luca-Timo/picpeak/commit/ab819989960e7e7336a47ba93a0472bfbcb10efb))
