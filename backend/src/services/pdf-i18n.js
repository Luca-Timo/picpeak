...
const LABELS = {
  en: {
    ...
    lead_in_quote: 'in accordance with our agreement, I am pleased to offer the following:',
    lead_in_invoice: 'in accordance with our agreement, I am invoicing the following:',
    table_pos: 'Pos.',
    table_qty: 'Qty',
  ...
  de: {
    ...
    lead_in_quote: 'gemäss unserer Absprache biete ich wie folgt an:',
    lead_in_invoice: 'gemäss unserer Vereinbarung berechne ich wie folgt:',
    table_pos: 'Pos.',
    table_qty: 'Anzahl',
  ...
  fr: {
    ...
    lead_in_quote: 'conformément à notre accord, je vous propose ce qui suit :',
    lead_in_invoice: 'conformément à notre accord, je facture ce qui suit :',
    table_pos: 'Pos.',
    table_qty: 'Qté',
    table_description: 'Description',
  ...
  nl: {
    ...
    lead_in_quote: 'overeenkomstig onze afspraak doe ik u het volgende voorstel:',
    lead_in_invoice: 'overeenkomstig onze afspraak factureer ik het volgende:',
    table_pos: 'Pos.',
    table_qty: 'Aantal',
  ...
  pt: {
    ...
    lead_in_quote: 'conforme combinado, ofereço o seguinte:',
    lead_in_invoice: 'conforme combinado, faturo o seguinte:',
    table_pos: 'Pos.',
    table_qty: 'Qtde.',
  ...
  ru: {
    ...
    lead_in_quote: 'согласно нашей договорённости, предлагаю следующее:',
    lead_in_invoice: 'согласно нашей договорённости, выставляю счёт на следующее:',
    table_pos: 'Поз.',
    table_qty: 'Кол-во',
