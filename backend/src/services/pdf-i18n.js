...
const LABELS = {
  en: {
    ...
    table_pos: 'Pos.',
    table_carry_forward: 'Carried forward',
    service_date_same_as_issue: 'same as invoice date',
    table_carry_brought: 'Brought forward',
    table_qty: 'Qty',
    ...
    integrity_missing: 'MISSING — the file (or record) is gone',
    ...
    cert_legal_notice: 'Legal notice',
    ...
    cert_event_data_requested: 'Customer details requested',
    cert_event_data_collected: 'Customer details received',
  ...
  de: {
    ...
    table_pos: 'Pos.',
    table_carry_forward: 'Übertrag',
    service_date_same_as_issue: 'entspricht Rechnungsdatum',
    table_carry_brought: 'Übertrag',
    table_qty: 'Anzahl',
    ...
    integrity_missing: 'FEHLT — die Datei (oder der Eintrag) ist nicht mehr vorhanden',
    ...
    cert_legal_notice: 'Rechtlicher Hinweis',
    ...
    cert_event_data_requested: 'Angaben der Kundschaft angefordert',
    cert_event_data_collected: 'Angaben der Kundschaft eingegangen',
  ...
  fr: {
    ...
    table_pos: 'Pos.',
    table_carry_forward: 'À reporter',
    service_date_same_as_issue: 'identique à la date de facture',
    table_carry_brought: 'Report',
    table_qty: 'Qté',
    table_description: 'Description',
  ...
  nl: {
    ...
    table_pos: 'Pos.',
    table_carry_forward: 'Transport',
    service_date_same_as_issue: 'gelijk aan factuurdatum',
    table_carry_brought: 'Transport',
    table_qty: 'Aantal',
  ...
  pt: {
    ...
    table_pos: 'Pos.',
    table_carry_forward: 'A transportar',
    service_date_same_as_issue: 'igual à data da fatura',
    table_carry_brought: 'Transporte',
    table_qty: 'Qtde.',
  ...
  ru: {
    ...
    table_pos: 'Поз.',
    table_carry_forward: 'Перенос',
    service_date_same_as_issue: 'совпадает с датой счёта',
    table_carry_brought: 'Перенос',
    table_qty: 'Кол-во',
